...
///
/// ```rust
/// # use serde_json_lodash::x_range_right_x;
/// # use serde_json::json;
/// assert_eq!(x_range_right_x(0, 20, 5), vec![15_isize, 10, 5, 0]);
/// ```
...
///
/// ```rust
/// # use serde_json_lodash::x_range_right;
/// # use serde_json::json;
/// assert_eq!(x_range_right(0, 20, 5), json!([15, 10, 5, 0]));
/// ```

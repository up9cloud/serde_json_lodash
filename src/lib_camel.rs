/// Batch of [build_link!] (fn + macro) aliases.
macro_rules! build_links {
    [ $($from:ident => $to:ident)+ ] => {
        $(
            build_link!($from, $to);
        )+
...
// the canonical name, generated by the shared `build_link!` mechanism from
// `macros.rs`.
build_links![
...
build_links![uniqueId => unique_id];

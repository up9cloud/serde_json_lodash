...
/// Fn form of [is_function!](crate::is_function!); see it for the full docs
///
/// `_x` forms: [is_function_x!](crate::is_function_x!), [is_function_x()]
///
/// Additional cases:
///
/// ```rust
...
///
/// Fn form: [is_function()] | `_x` forms: [is_function_x!](crate::is_function_x!), [is_function_x()]
///
/// Examples:
///
/// ```rust
...
/// `_x` helper for [is_function!](crate::is_function!): returns a primitive value instead of a [`Value`](crate::lib::Value).
///
/// Macro form: [is_function_x!](crate::is_function_x!) | `Value` forms: [is_function!](crate::is_function!), [is_function()]
///
/// Additional cases:
///
/// ```rust
...
/// `_x` helper for [is_function!](crate::is_function!): returns a primitive value instead of a [`Value`](crate::lib::Value).
///
/// Fn form: [is_function_x()] | `Value` forms: [is_function!](crate::is_function!), [is_function()]
///
/// Additional cases:
///
/// ```rust
